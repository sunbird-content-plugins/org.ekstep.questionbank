...
angular.module('createquestionapp', [])
  .controller('QuestionFormController', ['$scope', 'pluginInstance', function ($scope, pluginInstance) {
    ...
    $scope.init = function () {
      ...
      var filterMetaData = {};
      ecEditor.dispatchEvent('org.ekstep.editcontentmeta:showpopup', { action: 'question-filter-view', subType: 'questions', framework: "NCF", rootOrgId: ecEditor.getContext('channel'), type: 'content', popup: false, metadata: filterMetaData});
